...
- 配置：[c01-c02-ngksi-signal-inference.yaml](c01-c02-ngksi-signal-inference.yaml)，SHA-256：`223d74e36b2a8cb64d0a1f87d496327bd9e19a6fd94b8472266084d672e127c1`
- 结果：[c01-c02-ngksi-signal-candidates.json](c01-c02-ngksi-signal-candidates.json)，SHA-256：`a781c065ab5d4dc31318bebd3abd90bfa299a5301ffa106ce4a69154b53c7445`
...
为直接替换既有派生文件且不制造重复目录，文件名继续沿用 `c01-c02-*`；实际内容范围为 C01–C14。
